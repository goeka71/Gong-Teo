...
function ReviewFormModal({
  ...
  // 시설 리뷰(program 없이 작성된 리뷰)는 "내가 등록한 수강 프로그램" 목록
  // (programOptions)에 대응하는 항목이 존재하지 않는다. 수정 모달에서는
  // 이런 리뷰를 프로그램 선택 없이, 원본 리뷰의 시설/세부시설 정보 그대로
  // 수정할 수 있게 한다.
  const isFacilityReview =
    mode === "edit" &&
    Boolean(review) &&
    !review.programId;
